              ...
              <div className="flex flex-row justify-between items-center h-full gap-[70px]">
                <div className="flex flex-col justify-between h-[80%] w-full">
                  <label className="flex flex-col text-xl font-bold gap-[10px]">
                    Họ và tên:
                    <input type="text" {...register("full_name")} className="w-full p-2 border-2 border-solid border-black"/>
                    {errors.full_name && (
                ...
                <div className="flex flex-col justify-between h-[80%] w-full">
                  <div className="flex flex-row justify-between items-center">
                     ...
                     <label className="flex flex-col text-xl font-bold gap-[10px]">
                      Giới tính:
                      <select {...register("gender", { required: true })} className="w-full p-2 border-2 border-solid border-black">
                        <option selected disabled value="">
                          Giới tính
                        </option>
                   ...
                   <label className="flex flex-col text-xl font-bold gap-[10px]">
                    Ngày sinh:
                    <input type="date" {...register("date_of_birth")} className="w-full p-2 border-2 border-solid border-black" />
