      ...
      <div className={`flex lg:flex-row flex-col items-center gap-[50px]`}>
        <div className="flex flex-col gap-[40px]">
          ...
          <div className="lg:w-[600px] lg:h-[500px] w-[500px] h-[400px] relative">
            ...
            ></img>
            {productInfo.productInfo.status === 'ORDERED' && <div className="text-white text-xl font-bold absolute top-0 bg-[#DF6A6A] rounded-br-full px-8 py-8">Đang có người đặt hang</div>}
